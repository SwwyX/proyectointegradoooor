                ...
                <div class="col-xl-10 col-lg-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <span class="badge rounded-pill fs-5 px-4 py-2
                            ...
                            @elseif($estadoLimpio == 'en revision') bg-warning-subtle text-warning-emphasis border border-warning-subtle
                    ...
                    <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                        ...
                        <div class="card-body p-4">
                            ...
                            {{-- 5. INTERESES Y SOLICITUDES (ANAMNESIS MÚLTIPLE) --}}
                            <div class="mb-5">
                                    ...
                                    <div class="card-body bg-light">
                                        ...
                                        @if($caso->ajustes_ctp)
                                            <div class="mb-3">
                                                ...
                                                <div class="p-3 bg-white border rounded">{{ $caso->ajustes_ctp }}</div>
                                            </div>
                                        @endif
                        ...
                        <div class="card-footer bg-light p-3 text-end">
                            ...
                            @if(strtolower($caso->estado) == 'sin revision')
                                <a href="{{ route('encargada.casos.edit', $caso->id) }}" class="btn btn-primary px-4">

<x-app-layout>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-11 col-lg-12">
                    ...
                    <div class="text-center mb-4">
                        <h2 class="fw-bold text-body-emphasis">Entrevista de Ingreso - Ajustes Razonables</h2>
                        <p class="text-muted">Complete los antecedentes personales, familiares y académicos.</p>
                    </div>

                    {{-- BLOQUE DE ERRORES (¡ESTO FALTABA PARA QUE VEAS SI ALGO FALLA!) --}}
                    @if ($errors->any())
                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <form method="POST" action="{{ route('encargada.casos.store') }}" enctype="multipart/form-data" id="form-crear-caso">
                                @csrf
                                ...
                                <div id="seccion_detalle_caso" class="d-none animate__animated animate__fadeIn">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-7">
                                                <select name="via_ingreso" class="form-select" required>
                                                    ...
                                                    <option value="Declaración FUP">Estudiante declara discapacidad en FUP</option>
                                                    <option value="Derivación">Estudiante es derivado por profesional</option>
                                                    <option value="Solicitud Espontánea">Solicitud espontánea del estudiante</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    </div> <div class="alert alert-warning d-flex align-items-center border-warning shadow-sm" role="alert">
                                    ...
                                    <div class="d-flex justify-content-end mt-5 gap-2">
                                        <button type="button" class="btn btn-lg btn-outline-secondary" onclick="resetearFormulario()">
                                            Cancelar
                                        </button>
                                        <button type="submit" class="btn btn-lg btn-primary px-5">
                                            <i class="bi bi-save me-2"></i> Guardar Entrevista
                                        </button>
                                    </div>
    ...
    <script>
        ...
        function resetearFormulario() { location.reload(); }

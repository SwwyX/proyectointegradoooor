...
{{-- 
    CAMBIOS DE DISEÑO:
    1. bg-white: Fondo blanco para limpieza.
    2. py-3: Más altura (padding vertical) para que se vea moderna y grande.
    3. border-bottom-0: Quitamos bordes duros, usamos sombra.
    4. style="box-shadow...": Sombra difuminada personalizada muy elegante.
--}}
<nav class="navbar navbar-expand-lg navbar-light bg-white py-3 sticky-top" style="box-shadow: 0 4px 30px rgba(0,0,0,0.03);">
    
    <div class="container px-4"> {{-- Alineado con el contenido de las vistas --}}
        ...
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ $navDashboardRoute }}">
            ...
            {{-- 2. TEXTO CON FUENTE NUNITO (Más amigable) --}}
            <div class="d-flex flex-column justify-content-center">
                {{-- Aplicamos 'Nunito' aquí --}}
        ...
        <div class="collapse navbar-collapse" id="mainNavbarContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1">
                ...
                {{-- LÓGICA DE MENÚS POR ROL (Estilo unificado) --}}
                ...
                @if($userRolName == 'Asesoría Pedagógica')
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-3 rounded-pill fw-medium {{ $isActive ? 'active bg-teal-subtle text-teal fw-bold' : 'text-secondary' }}" 
                           ...
                           style="{{ $isActive ? 'color: #008080; background-color: #e6f2f2;' : '' }}"> {{-- Color personalizado Teal --}}
                            Supervisión Global
                        </a>
                    </li>
                @endif
            ...
            <div class="d-flex align-items-center ms-auto">
                ...
                {{-- Fecha (Oculta en móviles muy pequeños) --}}
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-4 p-2" aria-labelledby="userDropdown" style="min-width: 200px;">
                        ...
                        {{-- Header del Dropdown (Visible en móvil) --}}
